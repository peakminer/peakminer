...
|---|---|---|---|
| Previous PeakMiner | 115.6 TH/s | 284 W | 407 GH/W |
| **PeakMiner (latest)** | **143.5 TH/s** | 284 W | **505 GH/W** |

### ⚡ **+24% faster** · **+24% more efficient** — same card, same power.
...
| | Hashrate | Power | Efficiency |
|---|---|---|---|
| Previous PeakMiner | 69.7 TH/s | 164 W | 424 GH/W |
| **PeakMiner (latest)** | **79.8 TH/s** | 164 W | **488 GH/W** |

### ⚡ **+14% faster** · **+15% more efficient** — same card, same power.
...
- Results are identical-output verified — every share is mathematically correct
  and pool-accepted (0 rejects).
- Same single binary; no per-card configuration needed.
- More performance is on the way for cards that allow power/clock tuning.

*Measured 2026-06-15 on LuckyPool Pearl. Your numbers will vary slightly with
GPU model, cooling, power limit, and pool.*
