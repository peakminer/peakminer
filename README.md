...
| Field | Value |
|---|---|
| Installation URL | `https://github.com/peakminer/peakminer/releases/download/v2.2.2/peakminer-2.2.2.tar.gz` |
...
```bash
docker pull peakminer/peakminer:2.2.2

# Run — -t shows the live miner output
docker run --rm -t --gpus all peakminer/peakminer:2.2.2 \
...
docker build -t peakminer:2.2.2 --build-arg PEAKMINER_VERSION=2.2.2 .
...
```bash
docker run --rm -t --gpus all -p 4068:4068 peakminer/peakminer:2.2.2 \
